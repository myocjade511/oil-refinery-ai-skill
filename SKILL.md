...
Comprehensive regulatory permit application template for:
- Drilling permits
- Workover permits
...
Includes all required sections: applicant info, project description, environmental assessment, safety plans, public participation, and certifications.

### Feasibility Study
**File:** [templates/feasibility_study.md](templates/feasibility_study.md)

Full project feasibility study template including:
- Executive summary with recommendations
- Technical description and process design
- Market analysis and price forecasts
- Environmental and social impact assessment
- Implementation schedule and organization
- Economic analysis (CAPEX, OPEX, NPV, IRR)
...
### HAZOP Worksheet
**File:** [templates/hazop_worksheet.md](templates/hazop_worksheet.md)

Structured HAZOP (Hazard and Operability) study template:
- Study information and team members
- Design intent documentation
- Guide words and parameters reference
- Deviation analysis sections
- Risk ranking matrix
- Action item tracking
- Team sign-off and certifications
- Revision history
